...
import { precipLabel, windLabel } from '../../../src/prism/weather/descriptors'
...
describe('windLabel', () => {
  ...
  test('thresholds', () => {
    expect(windLabel(0)).toBe('静风')
    expect(windLabel(5.9)).toBe('静风')
    expect(windLabel(6)).toBe('微风')
    expect(windLabel(11.9)).toBe('微风')
    expect(windLabel(12)).toBe('和风')
    expect(windLabel(19.9)).toBe('和风')
    expect(windLabel(20)).toBe('清风')
    expect(windLabel(28.9)).toBe('清风')
    expect(windLabel(29)).toBe('强风')
    expect(windLabel(38.9)).toBe('强风')
    expect(windLabel(39)).toBe('劲风')
    expect(windLabel(49.9)).toBe('劲风')
    expect(windLabel(50)).toBe('大风')
    expect(windLabel(80)).toBe('大风')
  })
})
